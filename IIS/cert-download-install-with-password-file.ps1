...
if ( $CertNew.NotAfter -gt $CertCurrent.NotAfter ) {
    ...
    # We are using Import-PfxCertificate here and not the .NET function for reason!
    # Don`t even try to save cert using "System.Security.Cryptography.X509Certificates.X509Certificate2" - it will fail
    # with completely unrelated error!
